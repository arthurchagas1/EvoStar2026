...
MODEL_NAME   = "deepseek-ai/deepseek-llm-7b-chat"  # 7B, instruction-tuned
BENCH_PATH   = "/scratch/pedro.bento/evostar/math_benchmark.jsonl"
OUT_DIR      = "tot_deepseek_runs_7b_math"
...
def _norm_num(tok: str) -> str:
    ...
    if m:
        return f"{_norm_num(m.group(1))}/{_norm_num(m.group(2))}"
    t = t.replace("%", "")
    if "," in t and "." in t:
